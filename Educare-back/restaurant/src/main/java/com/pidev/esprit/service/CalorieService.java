...
public class CalorieService {
    ...
    public double getCaloriePercentage(String mealName, double height, double weight, int age, boolean isMale) {
    ...
    private double calculateMealPercentage(double mealCalories, double dailyCalories) {
